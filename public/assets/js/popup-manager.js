...
function buildPopupData(type, props) {
    ...
    if (type === 'institution_locations') return { title: escapePopup(props.institution_name || 'Institution Location'), subtitle: `${escapePopup(props.institution_type || 'Institution')} · ${escapePopup(props.institution_code || '-')}`, badge: 'INSTITUTION LOCATION', rows: `${popupRow('Contact Person', escapePopup(props.contact_person || '-'))}${popupRow('Phone', escapePopup(props.contact_phone || '-'))}${popupRow('Email', escapePopup(props.contact_email || '-'))}${popupRow('Website', escapePopup(props.website || '-'))}${popupRow('Address', escapePopup(props.address || '-'))}${popupRow('District', escapePopup(props.district || '-'))}${popupRow('DSD', escapePopup(props.dsd_name || '-'))}${popupRow('GND', escapePopup(props.gnd_name || '-'))}${popupRow('Status', formatActiveStatus(props.active))}${popupRow('Updated At', formatDate(props.updated_at))}` };
    if (type === 'volunteer_organisations') return { title: escapePopup(props.institution_name || props.organisation_name || 'Volunteer Organisation'), subtitle: `${escapePopup(props.organisation_type || props.institution_type || 'Volunteer Organisation')} · ${escapePopup(props.registration_no || props.institution_code || '-')}`, badge: 'VOLUNTEER ORGANISATION', rows: `${popupRow('Contact Person', escapePopup(props.contact_person || '-'))}${popupRow('Phone', escapePopup(props.contact_phone || '-'))}${popupRow('Email', escapePopup(props.contact_email || '-'))}${popupRow('Address', escapePopup(props.address || '-'))}${popupRow('DSD', escapePopup(props.dsd_name || '-'))}${popupRow('GND', escapePopup(props.gnd_name || '-'))}${popupRow('Performance Score', escapePopup(props.performance_score ?? '-'))}${popupRow('Status', formatActiveStatus(props.active))}` };
