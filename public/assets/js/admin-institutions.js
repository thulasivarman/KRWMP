window.KRWMP_ADMIN_INSTITUTIONS = {
    ...
    renderRow(row) {
        ...
        const actionButtons = this.canManage ? `<button data-action="edit" data-id="${row.id}"  class="krwmp-btn krwmp-btn-secondary krwmp-btn-sm border border-slate-700 px-2.5 text-[10px]">Edit</button><button data-action="deactivate" data-id="${row.id}"  class="krwmp-btn krwmp-btn-danger krwmp-btn-sm bg-rose-950/40 hover:bg-rose-900/60 border border-rose-900/40 text-rose-400 px-2.5 text-[10px]">Deactivate</button>` : '<span class="text-[10px] text-slate-600">View only</span>';
