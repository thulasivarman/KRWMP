...
window.KRWMP_ADMIN_UI = {
    ...
    getRegistrationPayload() {
        ...
        return { name: document.getElementById('regName').value, identifier: document.getElementById('regIdentifier').value, initials: document.getElementById('regInitials').value, designation: document.getElementById('regDesignation').value, role_id: roleIds[0], role_ids: roleIds, institution_id: document.getElementById('regInstitutionId')?.value || null, password: document.getElementById('regPassword').value };
    },
    getEditPayload() {
        return { name: document.getElementById('editName').value, designation: document.getElementById('editDesignation').value, initials: document.getElementById('editInitials').value, identifier: document.getElementById('editIdentifier').value, institution_id: document.getElementById('editInstitutionId')?.value || null };
    },
